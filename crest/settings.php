...
define('PAYROLL_ADDITIONS_ENTITY_TYPE_ID', 153);
define('PAYROLL_OVERTIMES_ENTITY_TYPE_ID', 154);
define('PAYROLL_DEDUCTIONS_ENTITY_TYPE_ID', 148);
define('EMPLOYEE_ENTITY_TYPE_ID', 171);